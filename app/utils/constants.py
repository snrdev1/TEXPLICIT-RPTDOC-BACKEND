...
KI_SEND_FOR_APPROVAL_MAILSUBJECT="Thank you for your contribution to TexplicitRW"
KI_SEND_FOR_APPROVAL_MAILBODY='''\
<p>
    Dear {receiver},
    <br/><br/>
    We wanted to take a moment to thank you for your recent contribution to TexplicitRW. We are thrilled to have you as part of our community and appreciate your effort in sharing your knowledge and resources with others. 
    <br/>
    <br/>
    ...
    <br/>
    <br/>
    We will notify you as soon as your contribution has been approved and is ready to be shared with the TexplicitRW community. In the meantime, you can continue to explore the platform and connect with others who are on their personal growth journeys.
    <br/>
    <br/>
    Thank you again for your support and for making TexplicitRW a vibrant and informative platform. If you have any questions or concerns, please don't hesitate to reach out to us at support@TexplicitRW.com.
...
# KI Approved
KI_APPROVED_MAILSUBJECT="Your Knowledge Item Has Been Approved on TexplicitRW"
KI_APPROVED_MAILBODY='''\
<p>
    Dear {receiver},
    <br/><br/>
    We are pleased to inform you that your knowledge item,{ki_title}, has been approved and is now available on TexplicitRW for the community to access and benefit from. 
    <br/>
    <br/>
    ...
    <br/>
    <br/>
    We encourage you to share your knowledge item with others and participate in the community. If you have any questions or need assistance, please don't hesitate to reach out to us at support@TexplicitRW.com.
    <br/>
    <br/>
    Thank you again for your support and for making TexplicitRW a vibrant and informative platform.
    <br/>
    <br/>
    Warm regards,
    <br/>
...
# KI Rejected
KI_REJECTED_MAILSUBJECT="Feedback on your Submission to TexplicitRW"
KI_REJECTED_MAILBODY='''\
<p>
    Dear {receiver},
    <br/><br/>
    We wanted to provide you with feedback on your recent submission to TexplicitRW, {ki_title}. After careful review, our team has decided not to approve your submission at this time.
    {reason}
    <br/>
    <br/>
    While we are unable to publish this particular submission, we appreciate your efforts in sharing your knowledge and resources with the community. Our goal is to provide a platform that supports personal growth and well-being, and our guidelines are in place to ensure that the content shared on TexplicitRW aligns with that goal.
    <br/>
    <br/>
    We encourage you to review our guidelines and consider submitting a revised version of your knowledge item in the future. If you have any questions or need assistance, please don't hesitate to reach out to us at support@TexplicitRW.com.
    <br/>
    <br/>

    Thank you for your understanding and for your support of TexplicitRW.
