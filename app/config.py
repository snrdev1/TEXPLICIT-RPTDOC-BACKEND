...
class Config(object):
    ...
    MAIL_SENDER_EMAIL = os.getenv(
        "MAIL_SENDER_EMAIL", "noreply@texplicitrw.com")
    ...
    REPORT_WEB_SCRAPER = os.getenv(
        "USE_WEB_SCRAPER", "newspaper")  # selenium / newspaper
    ...
    REPORT_BROWSE_CHUNK_MAX_LENGTH = int(
    ...
    REPORT_MAX_SEARCH_RESULTS_PER_QUERY = int(
    ...
    MONGO_USER_PERMISSIONS_MASTER_COLLECTION = "USER_PERMISSIONS_MASTER"
    ...
    MONGO_REPORT_PRICING_COLLECTION = "REPORT_PRICING"
    MONGO_DOCUMENT_PRICING_COLLECTION = "DOCUMENT_PRICING"
    MONGO_CHAT_PRICING_COLLECTION = "CHAT_PRICING"
    ...
    GCP_PROJECT_ID = os.getenv("GCP_PROJECT_ID", 'stoked-forest-413805')
    # Replace with your GCP project Name
    GCP_PROJECT_NAME = os.getenv("GCP_PROJECT_NAME", "My First Project")
